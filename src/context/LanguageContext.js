...
const translations = {
  en: {
    ...
    'gallery.clickToViewSpecies': 'Click to view all photos of this species',

    // Species Detail View
    'species.loading': 'Loading Species...',
    'species.loadingData': 'Loading species data...',
    'species.error': 'Error',
    'species.errorLoading': 'Error loading species data',
    'species.noSightings': 'No sightings found',
    'species.noSightingsTitle': 'No sightings of this species',
    'species.noSightingsDesc': 'No photos found for this bird species.',
    'species.backToGallery': 'Back to Gallery',
    'species.gridView': 'Grid',
    'species.timelineView': 'Timeline',
    'species.export': 'Export',
    'species.exportAll': 'Export All',
    'species.statistics': 'Statistics',
    'species.totalSightings': 'Total Sightings',
    'species.locations': 'Locations',
    'species.perMonth': 'Per Month',
    'species.firstSeen': 'First Seen',
    'species.lastSeen': 'Last Seen',
    'species.selected': 'selected',
    'species.photos': 'photos',
    'species.selectAll': 'Select All',
    'species.clearSelection': 'Clear',
    'species.sightingsCount': 'sightings',
    'species.sightings': 'sightings',
    'species.noDate': 'No date',
    'species.information': 'Species Information',
    'species.scientificName': 'Scientific Name',
    'species.family': 'Family',
    'species.size': 'Size',
    'species.wingspan': 'Wingspan',
    'species.habitat': 'Habitat',
    'species.diet': 'Diet',
    'species.description': 'Description',
    'species.dateTaken': 'Date Taken',
    'species.location': 'Location',
    'species.notes': 'Notes',
    'species.unknownScientific': 'Scientific name unknown',
    'species.unknownFamily': 'Family unknown',
    'species.unknownHabitat': 'Habitat information not available',
    'species.unknownDiet': 'Diet information not available',
    'species.unknownSize': 'Size unknown',
    'species.unknownWingspan': 'Wingspan unknown',
    'species.unknownConservation': 'Conservation status unknown',
    'species.unknownDescription': 'No description available for this species.',
  ...
  zh: {
    ...
    'gallery.clickToViewSpecies': '点击查看该物种的所有照片',

    // Species Detail View
    'species.loading': '加载物种中...',
    'species.loadingData': '加载物种数据中...',
    'species.error': '错误',
    'species.errorLoading': '加载物种数据时出错',
    'species.noSightings': '未找到观察记录',
    'species.noSightingsTitle': '此物种无观察记录',
    'species.noSightingsDesc': '未找到此鸟类物种的照片。',
    'species.backToGallery': '返回相册',
    'species.gridView': '网格',
    'species.timelineView': '时间线',
    'species.export': '导出',
    'species.exportAll': '导出全部',
    'species.statistics': '统计',
    'species.totalSightings': '总观察次数',
    'species.locations': '地点',
    'species.perMonth': '每月',
    'species.firstSeen': '首次观察',
    'species.lastSeen': '最近观察',
    'species.selected': '已选择',
    'species.photos': '照片',
    'species.selectAll': '全选',
    'species.clearSelection': '清除',
    'species.sightingsCount': '次观察',
    'species.sightings': '次观察',
    'species.noDate': '无日期',
    'species.information': '物种信息',
    'species.scientificName': '学名',
    'species.family': '科',
    'species.size': '体长',
    'species.wingspan': '翼展',
    'species.habitat': '栖息地',
    ...
    'species.dateTaken': '拍摄日期',
    'species.location': '位置',
    'species.notes': '备注',
    'species.unknownScientific': '学名未知',
    'species.unknownFamily': '科名未知',
    'species.unknownHabitat': '栖息地信息不可用',
    'species.unknownDiet': '食性信息不可用',
    'species.unknownSize': '体长未知',
    'species.unknownWingspan': '翼展未知',
    'species.unknownConservation': '保护状态未知',
    'species.unknownDescription': '该物种暂无描述信息。',
  ...
  es: {
    ...
    'gallery.clickToViewSpecies': 'Haz clic para ver todas las fotos de esta especie',

    // Species Detail View
    'species.loading': 'Cargando Especie...',
    'species.loadingData': 'Cargando datos de la especie...',
    'species.error': 'Error',
    'species.errorLoading': 'Error al cargar datos de la especie',
    'species.noSightings': 'No se encontraron avistamientos',
    'species.noSightingsTitle': 'Sin avistamientos de esta especie',
    'species.noSightingsDesc': 'No se encontraron fotos para esta especie de ave.',
    'species.backToGallery': 'Volver a la Galería',
    'species.gridView': 'Cuadrícula',
    'species.timelineView': 'Línea de Tiempo',
    'species.export': 'Exportar',
    'species.exportAll': 'Exportar Todo',
    'species.statistics': 'Estadísticas',
    'species.totalSightings': 'Avistamientos Totales',
    'species.locations': 'Ubicaciones',
    'species.perMonth': 'Por Mes',
    'species.firstSeen': 'Primera Vez Visto',
    'species.lastSeen': 'Última Vez Visto',
    'species.selected': 'seleccionados',
    'species.photos': 'fotos',
    'species.selectAll': 'Seleccionar Todo',
    'species.clearSelection': 'Limpiar',
    'species.sightingsCount': 'avistamientos',
    'species.sightings': 'avistamientos',
    'species.noDate': 'Sin fecha',
  ...
  fr: {
    ...
    'gallery.noDate': 'Aucune date',
    'gallery.invalidDate': 'Date invalide',
    'gallery.photosCount': 'photos',
    'gallery.clickToViewSpecies': 'Cliquez pour voir toutes les photos de cette espèce',

    // Species Detail View
    'species.loading': 'Chargement de l\'Espèce...',
    'species.loadingData': 'Chargement des données de l\'espèce...',
    'species.error': 'Erreur',
    'species.errorLoading': 'Erreur lors du chargement des données de l\'espèce',
    'species.noSightings': 'Aucune observation trouvée',
    'species.noSightingsTitle': 'Aucune observation de cette espèce',
    'species.noSightingsDesc': 'Aucune photo trouvée pour cette espèce d\'oiseau.',
    'species.backToGallery': 'Retour à la Galerie',
    'species.gridView': 'Grille',
    'species.timelineView': 'Chronologie',
    'species.export': 'Exporter',
    'species.exportAll': 'Tout Exporter',
    'species.statistics': 'Statistiques',
    'species.totalSightings': 'Observations Totales',
    'species.locations': 'Emplacements',
    'species.perMonth': 'Par Mois',
    'species.firstSeen': 'Première Vue',
    'species.lastSeen': 'Dernière Vue',
    'species.selected': 'sélectionnés',
    'species.photos': 'photos',
    'species.selectAll': 'Tout Sélectionner',
    'species.clearSelection': 'Effacer',
    'species.sightingsCount': 'observations',
    'species.sightings': 'observations',
    'species.noDate': 'Aucune date',
    'gallery.speciesName': 'Nom d\'espèce',
    'gallery.noPhotos': 'Aucune Photo Trouvée',
    'gallery.noPhotosDesc': 'Importez quelques photos pour commencer !',
    'gallery.adjustFilters': 'Essayez d\'ajuster vos filtres pour voir plus de résultats.',
  ...
  'zh-tw': {
    ...
    // Navigation descriptions
    'nav.gallery.desc': '瀏覽您的鳥類照片',
    'nav.journal.desc': '觀察記錄時間軸',
    'nav.map.desc': '觀察位置',
    'nav.import.desc': '新增照片',
    'nav.settings.desc': '應用程式偏好設定',
    
    // Gallery
    'gallery.title': '相簿',
    'gallery.subtitle': '瀏覽您的鳥類照片',
    'gallery.browse': '瀏覽您的鳥類照片',
    'gallery.refresh': '重新整理',
    'gallery.clearFilters': '清除篩選',
    'gallery.loading': '正在載入您的鳥類照片...',
    'gallery.errorLoading': '載入相簿時發生錯誤',
    'gallery.tryAgain': '重試',
    'gallery.search': '搜尋',
    'gallery.searchPlaceholder': '搜尋物種或備註...',
    'gallery.allSpecies': '所有物種',
    'gallery.startDate': '開始日期',
    'gallery.endDate': '結束日期',
    'gallery.sortBy': '排序方式',
    'gallery.newest': '最新優先',
    'gallery.oldest': '最舊優先',
    'gallery.speciesName': '物種名稱',
    'gallery.noPhotos': '未找到照片',
    'gallery.noPhotosDesc': '匯入一些照片以開始使用！',
    'gallery.adjustFilters': '嘗試調整您的篩選條件以查看更多結果。',
    'gallery.view': '檢視',
    'gallery.unknownSpecies': '未知物種',
    'gallery.noDate': '無日期',
    'gallery.invalidDate': '無效日期',
    'gallery.photosCount': '張照片',

    // Journal
    'journal.title': '日誌',
    'journal.subtitle': '您的觀鳥時間軸',
    'journal.loading': '正在載入您的觀鳥日誌...',
    'journal.errorLoading': '載入日誌時發生錯誤',
    'journal.expandAll': '展開全部',
    'journal.collapseAll': '收合全部',
    'journal.refresh': '重新整理',
    'journal.entriesCount': '筆記錄，橫跨',
    'journal.days': '天',
    'journal.noEntries': '尚無日誌條目',
    'journal.noEntriesDesc': '匯入一些照片並新增中繼資料以開始您的觀鳥日記！',
    'journal.sighting': '次觀察',
    'journal.sightings': '次觀察',
    'journal.today': '今天',
    'journal.yesterday': '昨天',
    'journal.unknownDate': '未知日期',
    'journal.noTime': '無時間',
    'journal.invalidTime': '無效時間',
    'journal.unknownSpecies': '未知物種',
    'journal.activityMap': '觀鳥活動',
    'journal.activityMapDesc': '您全年的觀鳥活動狀況',
    'journal.totalSightings': '總觀察次數',
    'journal.activeDays': '活躍天數',
    'journal.maxDay': '最佳日期',
    'journal.less': '少',
    'journal.more': '多',
    ...
    // Map
    'map.title': '觀察地圖',
    'map.subtitle': '在互動式地圖上探索您的觀鳥位置',
    'map.comingSoon': '互動式地圖即將推出',
    'map.description': '在互動式地圖上檢視您的所有鳥類觀察記錄，包括群集、位置詳情和路線追蹤。',
    'map.loading': '載入地圖中...',
    'map.errorLoading': '載入地圖資料時發生錯誤',
    'map.refresh': '重新整理',
    'map.locatedSightings': '個有位置的觀察記錄',
    'map.totalSightings': '總觀察次數',
    'map.uniqueSpecies': '物種',
    'map.locations': '位置',
    'map.locationDetails': '位置詳情',
    'map.legend': '地圖圖例',
    'map.birdSighting': '鳥類觀察',
    'map.clickForDetails': '點擊查看詳情',
    'map.noDate': '無日期',
    'map.invalidDate': '無效日期',

    // Import specific
    'import.title': '匯入照片',
    'import.subtitle': '將鳥類照片和中繼資料新增至您的收藏',
    'import.dropPhotos': '將照片放在這裡...',
    'import.dragDrop': '將鳥類照片拖放到這裡',
    'import.or': '或',
    'import.chooseFiles': '選擇檔案',
    'import.processing': '處理中...',
    'import.processPhotos': '處理照片',
    'import.clearAll': '全部清除',
    'import.processingResults': '處理結果',
    'import.successful': '成功',
    'import.failed': '失敗',
    'import.total': '總計',
    'import.errors': '錯誤',
    'import.importedPhotos': '已匯入的照片',
    'import.aibird': 'AI鳥類識別',
    'import.suggestSpecies': '建議物種',
    'import.analyzing': '分析中...',
    'import.confidence': '信心度',
    'import.useSuggestion': '使用建議',
    'import.birdSpecies': '鳥類物種',
    'import.searchSpecies': '搜尋鳥類物種...',
    'import.photoDetails': '照片詳情',
    'import.datetime': '日期和時間',
    'import.location': '位置',
    'import.latitude': '緯度',
    'import.longitude': '經度',
    'import.notes': '備註',
    'import.notesPlaceholder': '新增關於此次觀察的任何備註...',
    'import.noPhotosToProcess': '沒有要處理的照片！',
    ...
    'db.environment': '環境',
    'db.results': '測試結果',
    'db.sightings': '資料庫中的目前觀察記錄',

    // Settings
    'settings.title': '設定',
    'settings.subtitle': '設定您的觀鳥應用程式偏好',
    ...
    'settings.backup': '備份資料庫',
    'settings.version': '版本',
    'settings.appName': 'Avian Archive',
    'settings.description': '鳥類照片日誌',
